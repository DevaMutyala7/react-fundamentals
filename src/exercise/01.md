...
Basically a web page what we see in browser is HTML file which is represented in Document Object Modal by DOM API. DOM is programming interface to change or manipulate HTML file/web page.Through javascript we can manipulate the web page/document/HTML file.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=devateja58%40gmail.com).
