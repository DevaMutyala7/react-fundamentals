...
1. JSX is syntactic sugar over React API. JSX allows you to write code in html format but it isn't html. It makes code more readable and developer friendly. The JSX code you've written will be transpiled into Javascript which is understood by browser.

2. Babel is the transpiler used to transpile JSX into Javascript. In general Code is compiled during build time before it is shipped to browser but Babel is written in Javascript we can compile code during runtime in the browser on fly. However it isn't the same way in production.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=devateja58%40gmail.com).
