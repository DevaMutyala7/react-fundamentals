...
1. React is a declarative language i.e. it allows us to write code without worrying about how the things happening under the hood. It allows us to focus on what to do rather than how to do. So React API has come with methods to manipulate DOM e.g. React.createElement() and ReactDOM.render() methods.

2. React is starting point to use React in your code. You can create elements and nested elements using React object it's like *const newDiv = document.getElementById("heading").createElement("div")*. where as ReactDOM is to push that created element into DOM which is more like *newDiv.append("div")*

3. The reason why we have two objects as React and ReactDOM is React is common for multiple platforms like React native. ReactDOM is only for web applications to access the DOM.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=devateja58%40gmail.com).
